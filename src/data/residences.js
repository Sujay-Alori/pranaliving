...
import akashNew4 from '../assets/images/AKASH/akash-20260827T090927Z-1-001/akash/ChatGPT Image Aug 16, 2026, 03_16_28 PM.png';
import akashNew5 from '../assets/images/AKASH/akash-20260827T090927Z-1-001/akash/ChatGPT Image Aug 16, 2026, 03_16_31 PM.png';
import akashNew6 from '../assets/images/AKASH/akash-20260827T090927Z-1-001/akash/ChatGPT Image Aug 16, 2026, 03_16_32 PM.png';
import akashNew7 from '../assets/images/AKASH/akash-20260827T090927Z-1-001/akash/ChatGPT Image Aug 16, 2026, 03_16_35 PM.png';
import akashNew8 from '../assets/images/AKASH/akash-20260827T090927Z-1-001/akash/ChatGPT Image Aug 16, 2026, 03_23_50 PM.png';
import akashNew9 from '../assets/images/AKASH/akash-20260827T090927Z-1-001/akash/ChatGPT Image Aug 16, 2026, 03_34_49 PM.png';
import akashNew10 from '../assets/images/AKASH/akash-20260827T090927Z-1-001/akash/ChatGPT Image Aug 16, 2026, 03_34_51 PM.png';
import akashNew11 from '../assets/images/AKASH/akash-20260827T090927Z-1-001/akash/ChatGPT Image Aug 16, 2026, 03_36_07 PM.png';
...
export const residences = [
  {
    ...
    name: 'PRITHVI',
    meaning: 'Earth',
    element: 'Earth — Ground, Material, Place',
  ...
  },
  {
    ...
    name: 'VANAM',
    meaning: 'Forest',
    element: 'Forest — Vegetation, Landscape',
  ...
  },
  {
    ...
    name: 'VAYU',
    meaning: 'Air',
    element: 'Air — Movement, Ventilation',
...
const imageLists = {
  prithvi: [prithviImg, prithviGal1, prithviGal2, prithviGal3, prithviGal4],
  vanam: [vanamImg, vanamGal1, vanamGal2, vanamGal3, vanamGal4],
  surya: [suryaImg, suryaGal1, suryaGal2, suryaGal3, suryaGal4],
  jala: [jalaImg, jalaGal1, jalaGal2, jalaGal3, jalaGal4],
  vayu: [vayuImg, vayuGal1, vayuGal2, vayuGal3, vayuGal4],
  akash: [akashImg, akashNew1, akashNew2, akashNew3, akashNew4, akashNew5, akashNew6, akashNew7, akashNew8, akashNew9, akashNew10, akashNew11, akashNew12, akashNew13],
};

const akashVideos = akashVideo ? [{ src: akashVideo, type: 'video/mp4', poster: akashImg, title: 'AKASH' }] : [];

export const mediaCategories = residences.map((residence) => {
  const media = categoryMedia[residence.id];
  const imgSrcs = media && media.images.length ? media.images : imageLists[residence.id] || [];
  const images = imgSrcs.map((src) => ({ src, alt: residence.imageAlt }));
  const videos = media && media.videos.length
    ? media.videos.map((src) => ({ src, type: 'video/mp4', poster: residence.image, title: residence.name }))
    : residence.id === 'akash'
      ? akashVideos
      : [];
  return {
    ...
    images,
    videos,
    hasNone: images.length === 0 && videos.length === 0,
  };
});
...
export const navLinks = [
  ...
  { label: 'Flats', href: '#flats', route: 'flats', src: suryaImg },
